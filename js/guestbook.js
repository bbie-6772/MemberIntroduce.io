...
//         new Date($(this).prev().prev().find('h3').data('date')).getTime() *
//             0.001
//     );
...
//             //댓글을 firebase에서 삭제
//             deleteDoc(doc(db, 'comments', docRef.id)).then(() =>
//                 //댓글을 화면에서 삭제
//                 $(this)
//                     .parent()
//                     .remove()
...
//         await addDoc(collection(db, 'comments'), innerDoc).then(() =>
